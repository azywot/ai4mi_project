...
# python stitch.py --data_folder data/SEGTHOR_CLEAN/val/gt --dest_folder val_prep_42/gt --num_classes 5 --grp_regex "(Patient_\d\d)_\d\d\d\d" --source_scan_pattern "data/segthor_fixed/train/{id_}/GT.nii.gz"
...
python stitch.py --data_folder data/SEGTHOR_CLEAN/val/gt --dest_folder val_prep_420/gt --num_classes 5 --grp_regex "(Patient_\d\d)_\d\d\d\d" --source_scan_pattern "data/segthor_fixed/train/{id_}/GT.nii.gz"
...
# python stitch.py --data_folder data/SEGTHOR_CLEAN/val/gt --dest_folder val_prep_37/gt --num_classes 5 --grp_regex "(Patient_\d\d)_\d\d\d\d" --source_scan_pattern "data/segthor_fixed/train/{id_}/GT.nii.gz"
