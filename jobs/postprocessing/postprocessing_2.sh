...
#SBATCH --output=outfiles/postprocessing_2_%A.out
...
python crf_postprocessing.py \
    --input_folder val/val_42/pred \
    --output_folder val/val_42/pred_crf_full \
    --num_classes 5 \
    --spatial_weight 1.0 \
...
python crf_postprocessing.py \
    ...
    --output_folder val/val_37/pred_crf_full \
    --num_classes 5 \
    --spatial_weight 1.0 \
    --bilateral_weight 1.0 \
    --num_iterations 5
...
python crf_postprocessing.py \
    --input_folder val/val_420/pred \
    --output_folder val/val_420/pred_crf_full \
    --num_classes 5 \
    --spatial_weight 1.0 \
    --bilateral_weight 1.0 \
    --num_iterations 5
    
#python distorch/compute_metrics.py --ref_folder val/val_gt --pred_folder val/val_42/pred --ref_extension .nii.gz --pred_extension .nii.gz --num_classes 5 --metrics 3d_dice 3d_hd95 --save_folder val/val_42
python distorch/compute_metrics.py --ref_folder val/val_gt --pred_folder val/val_42/pred_crf_full --ref_extension .nii.gz --pred_extension .nii.gz --num_classes 5 --metrics 3d_dice 3d_hd95 --save_folder val/val_42/crf_full
...
python distorch/compute_metrics.py --ref_folder val/val_gt --pred_folder val/val_37/pred_crf_full --ref_extension .nii.gz --pred_extension .nii.gz --num_classes 5 --metrics 3d_dice 3d_hd95 --save_folder val/val_37/crf_full
...
python distorch/compute_metrics.py --ref_folder val/val_gt --pred_folder val/val_420/pred_crf_full --ref_extension .nii.gz --pred_extension .nii.gz --num_classes 5 --metrics 3d_dice 3d_hd95 --save_folder val/val_420/crf_full
